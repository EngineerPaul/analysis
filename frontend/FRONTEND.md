...
- `/archive` — загрузка/скачивание/удаление файлов
...
- `/archive` — хранение загруженных файлов
...
Зависимости: `jspdf`, `jspdf-autotable`, `xlsx`. Кириллица — шрифты DejaVu в `public/fonts/` (текст в PDF выделяемый).
